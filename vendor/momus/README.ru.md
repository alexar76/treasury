...
<p align="center">
  <a href="https://momus.modelmarket.dev/">
    <img src="docs/screenshots/readme/hero.png" alt="MOMUS — немигающий глаз, сканирует и подписывает" width="860">
  </a>
  <br>
  <sub><b>Аудитор, который находит изъян и <b>подписывает</b> доказательство.</b> — <a href="https://momus.modelmarket.dev/"><b>живая панель →</b></a> · <a href="https://alexar76.github.io/momus/"><b>лендинг →</b></a> · <a href="#run-it"><b>запустить локально →</b></a></sub>
</p>

<p align="center">
  <strong>MOMUS</strong> — <strong>красная команда</strong> экосистемы, живущая в её же доме<br/>
  Находит изъян · <strong>подписывает</strong> доказательство · <strong>не может заплатить себе</strong> · кормит <a href="https://github.com/alexar76/argus">синюю команду</a>
</p>

<p align="center">
  <strong><a href="https://momus.modelmarket.dev/">Живая панель</a></strong>
  ·
  <strong><a href="docs/warden-channel.ru.md">Канал MOMUS → WARDEN</a></strong>
  ·
  <strong><a href="docs/found-and-fixed.ru.md">Найденные и починенные баги</a></strong>
  ·
  <strong><a href="docs/first-cycle.ru.md">Первый живой цикл</a></strong>
  ·
  <strong><a href="docs/uni-chain.ru.md">Каждая транзакция по шагам</a></strong>
  ·
  <strong><a href="docs/reward-rail.ru.md">Рельс вознаграждения</a></strong>
  ·
...
- **PyPI:** `aimarket-momus` · **Прод-хост:** oracle-хост, опубликован на `momus.modelmarket.dev`
...
<p align="center">
  <img src="docs/screenshots/readme/panel.png" alt="Живая панель MOMUS — находки, разделение ключей, самообучение" width="860"><br>
  <sub>Живая панель · подписанные находки · доказательство разделения ключей · приоритеты проб, которые выучил бандит</sub>
</p>

<p align="center">
  <img src="docs/screenshots/readme/monitor.png" alt="MOMUS и Treasury как узлы в Alien Monitor" width="860"><br>
  <sub>MOMUS и Treasury отдельными узлами в <a href="https://monitor.modelmarket.dev/">Alien Monitor</a> — клик по любому открывает его живую панель</sub>
</p>
...
> весь дизайн.
>
> **Развёрнутый контракт — это ещё не включённые выплаты.** [`BountySplitter`](https://github.com/alexar76/aicom/blob/main/contracts/evm/src/BountySplitter.sol)
...
экосистемы: [`docs/onchain-journal.md`](https://github.com/alexar76/aicom/blob/main/docs/onchain-journal.md).

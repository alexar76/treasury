...
export function CosmicCanvas({
  ...
  return (
    <Canvas camera={{ position: camera, fov }} dpr={coarse ? [1, 1] : [1, 2]}
      ...
      {children}
      {/* Post-processing stack is skipped on touch devices: the extra render targets
          (bloom mipmap chain + vignette) stress mobile GPUs into WebGL context loss,
          which manifests as a black flash / blink cycle on phones. */}
      {!coarse && (

...
- **PyPI :** `aimarket-momus` · **Hôte de production :** serveur 2 (`modeldev`), publié sur `redteam.modelmarket.dev`
...
> le design.
>
> **Un contrat déployé n'est pas un paiement activé.** [`BountySplitter`](../contracts/evm/src/BountySplitter.sol)
...
(`contracts/evm/test/BountySplitter.t.sol`). Liste complète des adresses de l'écosystème : [`docs/onchain-journal.md`](../docs/onchain-journal.md).

...
MOMUS finds hostile third-party MCP servers. [WARDEN](https://github.com/alexar76/argus) — the
firewall inside every ARGUS install — decides which servers its owner may touch. Until this channel

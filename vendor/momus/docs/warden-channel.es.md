...
MOMUS encuentra servidores MCP hostiles de terceros. [WARDEN](https://github.com/alexar76/warden) — el
cortafuegos MCP, distribuido como el paquete independiente `@aimarket/warden` y ejecutado por cada
instalación de ARGUS — decide a qué servidores puede conectarse su
...
WARDEN comprueba tres propiedades y **conserva su base mínima integrada si cualquiera de ellas falla**:
...
**Confiar en MOMUS solo puede AÑADIR denegaciones, nunca quitar ninguna.** La base mínima integrada de WARDEN
...
[agentes de nodo de despliegue](found-and-fixed.es.md).
...
| Suite | Qué cubre |
|---|---|
| `momus/tests/test_warden_feed.py` (31) | reglas de rechazo, formato de transmisión, determinismo, codificación SPKI, acuerdo JCS con la referencia AWR, **firma verificada por el propio verificador de ARGUS** |

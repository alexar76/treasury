...
MOMUS trouve des serveurs MCP tiers hostiles. [WARDEN](https://github.com/alexar76/warden) — le
pare-feu MCP, distribué comme le paquet autonome `@aimarket/warden` et exécuté par chaque
installation d'ARGUS — décide à quels serveurs son propriétaire a le
...
[agents de nœud de déploiement](found-and-fixed.fr.md).
